  ...
  <div class="min-h-screen pt-20 bg-white">
    ...
    <template v-else-if="store.currentProduct">
      <div class="max-w-5xl mx-auto px-4 py-6">
        <div class="mb-6">
          <button class="text-emerald-600 hover:text-emerald-700 font-medium text-sm transition-colors" @click="navigate(backPath)">
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-10 pb-10 border-b border-gray-200">
          ...
          <div>
            ...
            <p class="text-base text-gray-700 mb-6">{{ shortDescription }}</p>
        ...
        <div class="mb-10 pb-10 border-b border-gray-200">
          ...
          <p class="text-sm text-gray-700 whitespace-pre-line leading-relaxed">{{ aboutTreatment }}</p>
        </div>
