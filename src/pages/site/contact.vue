    ...
    <section class="py-8 px-4 border-b border-gray-200">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <p class="text-base text-gray-700">
          We're here to answer your questions and help you start your health journey
        </p>
      </div>
    </section>
        ...
        <div class="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            >
              ...
              <div
                v-if="submitted"
                class="mb-5 p-3 gradient-bg-light text-emerald-800 rounded-lg text-sm border-2 border-emerald-200"
              >
