  ...
  <div class="min-h-screen pt-20 bg-white">
    <section class="py-8 px-4 border-b border-gray-200">
      <div class="max-w-4xl mx-auto text-center">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">About FitByShot</h1>
        <p class="text-base text-gray-700">Your trusted partner in health and wellness</p>
      </div>
    </section>
    ...
    <section class="py-12 bg-white">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="space-y-8">
          ...
          <div>
            <h2 class="text-xl font-bold text-gray-900 mb-3">Our Approach</h2>
            <p class="text-sm text-gray-700 leading-relaxed">
          ...
          <div>
            <h2 class="text-xl font-bold text-gray-900 mb-3">Our Treatments</h2>
            <p class="text-sm text-gray-700 leading-relaxed mb-3">
              We offer a comprehensive range of evidence-based treatments across three key categories:
            </p>
            <ul class="space-y-2 text-sm text-gray-700">
              <li><strong>Weight Loss:</strong> Semaglutide and Tirzepatide for sustainable weight loss and improved metabolic health</li>
              <li><strong>Wellness:</strong> B12 for energy and metabolism, Glutathione for immunity and detoxification</li>
              <li><strong>Longevity:</strong> NAD+ therapy for cellular energy and healthy aging</li>
            </ul>
          </div>

          <div>
            <h2 class="text-xl font-bold text-gray-900 mb-3">Why Choose FitByShot</h2>
            <ul class="space-y-2 text-sm text-gray-700">
              <li>Personalized telehealth consultations and medical oversight</li>
              <li>Treatment plans specific to your health and wellness goals</li>
              <li>Convenient delivery reliably right to your door</li>
              <li>Support for body, mind, and cellular health</li>
              <li>Ongoing medical support throughout your wellness journey</li>
            </ul>
          </div>

          <div>
            <h2 class="text-xl font-bold text-gray-900 mb-3">Research-Backed Approach</h2>
            <p class="text-sm text-gray-700 leading-relaxed mb-3">
