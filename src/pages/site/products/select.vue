...
<template>
  <div class="min-h-screen pt-20 bg-white">
    ...
    >
      <div class="animate-spin rounded-full h-16 w-16 border-b-2 border-emerald-600" />
    </div>
    ...
    >
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto">
          Choose the treatment you'd like to learn more about and view pricing options.
        </p>
      </div>

      <div
        v-if="store.allProducts.length === 0"
      ...
      >
        ...
        >
          <div
            class="aspect-square rounded-lg mb-4 flex items-center justify-center overflow-hidden"
          ...
          >
            ...
            <div
              v-else
              class="w-20 h-20 bg-white rounded-full border-2 border-emerald-200 flex items-center justify-center"
            >
