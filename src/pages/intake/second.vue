  ...
  >
    <VRow>
      <VCol cols="12" class="mb-4">
        <VCard>
            <VCardText>
                <h4 class="text-center mb-">PATIENT INFORMATION</h4>
                <h5 class="text-center mb-4">(SELECT if it does NOT apply)</h5>
                <VForm
                    ref="refVForm"
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">                      
                        <VCol cols="2" class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['constitutional']"></VCheckbox>
                        </VCol>                      
                      </VRow>
                    ...
                    <VCol cols="12" >
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['head']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['eyes']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['nose']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['mouth']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['ears']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['throat_neck']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['respiratory']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['cardiovascular']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['gastrointestinal']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['musculoskeletal']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['skin']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['endocrine']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['urinary']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                    ...
                    <VCol cols="12">
                      <VRow class="px-2">
                        <VCol class="d-flex align-center">
                          ...
                          <VCheckbox v-model="intake['neurological']"></VCheckbox>
                        </VCol>
                      </VRow>
                      <VRow class="mb-2 px-2">
                  ...
                  <VRow v-if="patientId" class="my-2 px-2 justify-center">
                    <VBtn v-if="loading == false" size="large" @click="saveForm()" style="width: 15rem;">DONE</VBtn>
