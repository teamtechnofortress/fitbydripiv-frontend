              ...
              <VRow class="mb-4">
                ...
                >
                  <VRow class="mb-2 px-2">                      
                    ...
                    >
                      <p class="me-4">
                        I CERTIFY THAT ALL THE INFORMATION PROVIDED ABOVE IS TRUE AND COMPLETE TO THE BEST OF MY KNOWLEDGE. I UNDERSTAND THAT IV THERAPY AND INJECTIONS ARE  A MEDICAL TREATMENT AND THAT THE STAFF WILL USE THE CERTIFIED INFORMATION I PROVIDED TO DETERMINE MY SUITABILITY FOR TREATMENT. I AUTHORIZE FITBYDRIP TO ADMINISTER IV AND OTHER THERAPIES INCLUDING INJECTIONS AS DEEMED APPROPRIATE BASED ON MY HEALTH INFORMATION.
                      </p>
                    </VCol>                      
                  </VRow>
                  ...
                  <VRow class="px-2">
                    ...
                    >
                      ...
                      <VTextField
                        v-model="intake['agreedTxt']"
                        label="AGREED TO UNCONDITIONALLY"
                        variant="underlined"
                  ...
                  <VRow
                    v-if="patientId"
                    class="my-4 px-2 justify-center pt-4"
                  >
                    <VBtn
                      v-if="loading == false"
                      size="large"
                      style="width: 15rem;"
                      @click="isCongratsDialogVisible = true;"
                    >
                      Finish
                    </VBtn>
                    <VBtn
