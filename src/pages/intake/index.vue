  ...
  >
    <VRow>
      ...
      >
        <VCard>
          <VCardText>
            <h4 class="text-center my-4 pb-4">
              ...
              <VRow class="mb-4">
                ...
                >                    
                  <VRow class="mt-2 px-2 bg-primary">
                    <VCol
                      cols="2"
                      class="d-flex align-center text-"
                    >
                      GOAL:
                    </VCol>
                    <VRadioGroup
                ...
                >                    
                  <VRow class="my-2 px-2">
                    <VCol class="d-flex align-center">
                      ...
                      <VCheckbox v-model="hydration" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">ENERGY</label>
                      <VCheckbox v-model="energy" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">RECOVERY</label>
                      <VCheckbox v-model="recovery" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">PAIN</label>
                      <VCheckbox v-model="pain" />
                    </VCol>
                  </VRow>
                  ...
                  <VRow class="my-2 px-2">
                    <VCol class="d-flex align-center">
                      ...
                      <VCheckbox v-model="supplements" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">FATIGUE</label>
                      <VCheckbox v-model="fatigue" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">HEADACHE</label>
                      <VCheckbox v-model="headache" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">SORENESS</label>
                      <VCheckbox v-model="soreness" />
                    </VCol>
                  </VRow>
                  ...
                  <VRow class="my-2 px-2">
                    <VCol class="d-flex align-center">
                      ...
                      <VCheckbox v-model="current_illness" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">RECENT ILLNESS</label>
                      <VCheckbox v-model="recent_illness" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">HANGOVER</label>
                      <VCheckbox v-model="hangover" />
                    </VCol>                    
                  </VRow>
                  ...
                  <VRow class="my-2 px-2">
                    <VCol class="d-flex align-center">
                      ...
                      <VCheckbox v-model="low_energy" />
                    </VCol>
                    <VCol class="d-flex align-center">
                      <label class="me-4">IMMUNITY</label>
                      <VCheckbox v-model="immunity" />
                    </VCol>                      
                    <VCol class="d-flex align-center">
                      <label class="me-4">BEAUTY</label>
                      <VCheckbox v-model="beauty" />
                    </VCol>                      
                  </VRow>
                  ...
                  <VRow class="my-2 px-2 justify-center">
                    ...
                    >
                      ...
                      <VRadioGroup
                        v-model="patientInformationRegType"
                        inline
                      >
                        <VRadio
                          label="NEW"
                  ...
                  <div v-if="patientInformationRegType == 'new'">
                    ...
                    <VRow class="my-2 px-2">
                      ...
                      >
                        ...
                        <VCheckbox v-model="patient['pregnant']" />
                      </VCol>
                      <VCol
                        class="d-flex align-center"
                        cols="2"
                      >
                        ...
                        <VCheckbox v-model="patient['tobacco']" />
                      </VCol>
                      <VCol
                        class="d-flex align-center"
                        cols="2"
                      >
                        ...
                        <VCheckbox v-model="patient['drug_use']" />
                      </VCol>
                    </VRow>
                  ...
                  <div v-if="patientInformationRegType == 'existing'">
                    ...
                    <VRow class="my-2 px-2">
                      <VCol class="d-flex align-center">
                        <VCheckbox v-model="patient['emailNotify']" />
