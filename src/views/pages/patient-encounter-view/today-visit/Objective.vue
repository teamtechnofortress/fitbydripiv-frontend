                ...
                <VCard>
                    <VCardText class="mb-4">
                        ...
                        <VRow class="my-4">
                          ...
                          <VDivider />
                          <VTextarea v-model="physicalExam['notes']" rows="10"></VTextarea>                            
                        </VRow>

                        <h4 class="mt-4 pt-4">VITALS</h4>
                        <VDivider />
                        <VRow class="mt-2">
                            <VCol cols="3">
                                <VTextField
                        ...
                        <VRow class="mt-4 pt-4">
                            <VBtn v-if="!isLoading" class="d-flex mx-auto" color="primary" @click="isConfirmDialogVisible=!isConfirmDialogVisible">UPDATE NOTES</VBtn>
