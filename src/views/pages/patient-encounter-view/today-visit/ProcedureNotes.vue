            ...
            <VCardText class="mb-4">
                ...
                <VRow class="m">
                  <VCol cols>
                    ...
                    <p class="text-danger">{{ patient.current_conditions }}</p>
                  </VCol>
                  <VCol cols>
                    <label class="text-warning me-2 italic">Current Allergies:</label>
                    <p class="text-danger">{{ patient.current_allergies }}</p>
                  </VCol>

                  <VCol cols>
                    <label class="text-warning me-2 italic">Allergy Reactions:</label>
                    <p class="text-danger">{{ patient.allergy_reactions }}</p>
                  </VCol>
                  <VCol cols>
                    <label class="text-warning me-2 italic">Current Medication:</label>
                    <p class="text-danger">{{ patient.current_medications }}</p>
                  </VCol>
                </VRow>                
                <h4 class="my-4">PROCEDURE NOTES:</h4>
                <VRow class="mb-4">
                  <VTextarea 
                ...
                <h4 class="mb-3">PROCEDURE RISK</h4>
                <VRow class="mb-4">
                    <VTextarea v-model="patientProcedure['risk']" label="Risk:" rows="10" :rules="[requiredValidator]"></VTextarea>                            
                </VRow>

                <h4 class="mb-3">PROCEDURE BENEFITS</h4>
                <VRow class="mb-4">
                    <VTextarea v-model="patientProcedure['benefits']" label="Benefits:" rows="10" :rules="[requiredValidator]"></VTextarea>                            
                </VRow>

                <h4 class="mb-3">ALTERNATIVES</h4>
                <VRow class="mb-4">
                    <VTextarea v-model="patientProcedure['alternatives']" label="Alternatives:" rows="10" :rules="[requiredValidator]"></VTextarea>                            
                </VRow>  
                ...
                <VRow class="mt-4 pt-4">
                    <VBtn v-if="!isLoading" class="d-flex mx-auto" color="primary" @click="isConfirmDialogVisible=!isConfirmDialogVisible">UPDATE PROCEDURE PLAN</VBtn>
