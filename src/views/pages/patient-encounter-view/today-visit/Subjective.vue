                ...
                <VCardText class="mb-4">
                    <VRow class="mb-2">                    
                        ...
                        <VCol class="d-flex align-center" cols="3" sm="12" md="3">
                            ...
                            <div class="border-bottom">{{ patient.birthday }}</div>
                        </VCol>                    
                    ...
                    <VRow class="mt-4 pt-4">
                        <VBtn v-if="!isLoading" class="d-flex mx-auto" color="primary" @click="isConfirmDialogVisible=!isConfirmDialogVisible">UPDATE COMPLAINT NOTES</VBtn>
