...
import AppointmentReportDialog from "./appointment-report-dialog.vue";

const showChartHistoryDialog = ref(false);
const toast = useToast();

const getAllAppointmentReports = () => {
  Network.getRequest(Const.ALL_APPOINTMENT_REPORT, {}, {}, (response)=>{
...
function doConfirm(value){
  if(value){
    Network.getRequest(`${Const.DELETE_APPOINTMENT_REPORT}/${rmRecordId.value}`, {}, {}, 
      (response) => {
        if(response.data.success){
          toast.success("Successfully Deleted Appointment Report.");              
...
<template>
  <section>
          ...
          <VTable class="text-no-wrap">
            <thead>
              <tr>
                ...
                <th scope="col" class="font-weight-semibold">Online</th>
                <th scope="col" class="font-weight-semibold">Phone In</th>
                <th scope="col" class="font-weight-semibold">Walk In</th>
                <th scope="col" class="font-weight-semibold">No Show</th>                
    ...
    <AppointmentReportDialog v-model="showChartHistoryDialog" @refresh="getAllAppointmentReports()"/>
  </section>  
</template>
