  ...
  <VForm ref="refVForm" @submit.prevent="saveForm">
    <VCard>
      ...
      <div class="text-subtitle-1 mt-2 mx-4">
        <VTextField @input="getPatientDataById(patient['id'])" v-model="patient['id']" label="PATIENT NUMBER" :rules="[requiredValidator]" style="width: 15rem;"></VTextField>
      </div>
      <VRow class="mx-4 mt-2">
        <VCol class="d-flex align-center" cols="8">
      ...
      <VCardText>
        ...
        <VRow>
          ...
          >
            ...
            <input type="date" v-model="chartHistory['range_sdate']"/>
          </VCol> 
          <VCol
            cols="6"
            class="d-flex align-center"
          >
            ...
            <input type="date" v-model="chartHistory['range_edate']"/>            
          </VCol> 
        </VRow>        
        ...
        <VRow class="mt-2">
          <VCol cols="4" class="d-flex align-center">
            <VTextField v-model="chartHistory['email']" type="email" label="EMAIL" :rules="[requiredValidator, emailValidator]"></VTextField>
          </VCol> 
        </VRow>
