        ...
        <VCardText>
          ...
          <VRow>
            ...
            >
              ...
              <input
                v-model="customerService['range_sdate']"
                type="date"
              >
            </VCol> 
            <VCol
            ...
            >
              ...
              <input
                v-model="customerService['range_edate']"
                type="date"
              >            
            </VCol> 
          </VRow>
          ...
          <VRow>
            ...
            >
              ...
              <input
                v-model="customerService['arrive_stime']"
                type="time"
              >            
            </VCol> 
            <VCol
            ...
            >
              ...
              <input
                v-model="customerService['arrive_etime']"
                type="time"
              >            
            </VCol> 
          </VRow>
