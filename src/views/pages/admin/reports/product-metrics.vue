...
import ProductMetricsDialog from "./products-metrics-dialog.vue";

const showChartHistoryDialog = ref(false);
const toast = useToast();

const getAllProductMetrics = () => {
  Network.getRequest(Const.ALL_PRODUCT_METRICS, {}, {}, (response)=>{
...
function doConfirm(value){
  if(value){
    Network.getRequest(`${Const.DELETE_PRODUCT_METRICS}/${rmRecordId.value}`, {}, {}, 
      (response) => {
        if(response.data.success){
          toast.success("Successfully Deleted Product Metrics.");              
...
<template>
  <section>
          ...
          <VTable class="text-no-wrap">
            <thead>
              <tr>
                ...
                <th scope="col" class="font-weight-semibold">Semaglutide</th>
                <th scope="col" class="font-weight-semibold">Tirzepatide</th>
                <th scope="col" class="font-weight-semibold">IV</th>
                <th scope="col" class="font-weight-semibold">Injections</th>
                <th scope="col" class="font-weight-semibold">Peptides</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="text-center">
                  <div class="v-avatar-group">
                    {{ item.isSemaglutide ? 'Yes' : 'No' }}
                  </div>
                </td>                          
                <td class="text-center">
                  <div class="v-avatar-group">
                    {{ item.isTirzepatide ? 'Yes' : 'No' }}
                  </div>
                </td> 
                <td class="text-center">
                  <div class="v-avatar-group">
                ...
                <td class="text-center">
                  <div class="v-avatar-group">
                    {{ item.isInjections ? 'Yes' : 'No' }}
                  </div>
                </td> 
                <td class="text-center">
                  <div class="v-avatar-group">
                    {{ item.isPeptides ? 'Yes' : 'No' }}
                  </div>
                </td> 
                <td class="text-center">
                  <div class="v-avatar-group">
    ...
    <ProductMetricsDialog v-model="showChartHistoryDialog" @refresh="getAllProductMetrics()"/>
  </section>  
</template>
