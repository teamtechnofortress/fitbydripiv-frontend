...
function saveForm(){ 
  refVForm.value?.validate().then(({ valid: isValid }) => {
    ...
    if (isValid){  
      ...
      Network.postRequest(Const.SAVE_REWARD_REPORT, {}, {...reward.value, ...rangeDate}, (response)=>{        
        loading.value = false;
      ...
      <VCardText>
        ...
        <VRow>
          <VCol 
            ...
            >            
            <VCheckbox
              v-model="reward['totalRewardPurchases']"
              label="TOTAL REWARD PROGRAM PURCHASES"
            />
          </VCol>                 
        </VRow>
