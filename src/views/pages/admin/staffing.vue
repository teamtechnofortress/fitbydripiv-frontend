                  ...
                  <VRow class="mb-4 px-4"> 
                    <VCol class="d-flex align-center">
                      ...
                      <VTextField
                        ...
                        type="number"
                        variant="underlined"
                        :rules="[requiredValidator, minValueValidator, maxValueValidator]"
                        :input-attrs="{ min: 0, max: 25 }"
                      />
                    </VCol>
                    <VCol class="d-flex align-center">
