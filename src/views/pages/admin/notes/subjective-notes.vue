            ...
            <VCard>
                <VCardText class="mb-4">
                    ...
                    <VRow class="mt-2">
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="complaintText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow>
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="allergiesText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow>
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="medicationText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow>
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="systemReviewText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow>
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="conditionsText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow class="mt-4 pt-4">
                        <VBtn v-if="!isLoading" class="d-flex mx-auto" color="primary" type="submit">UDPATE COMPLAINT NOTES</VBtn>
