            ...
            <VCard>
                <VCardText class="mb-4">
                    ...
                    <VRow class="mt-2">
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="riskText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow>
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="benefitText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
                    ...
                    <VRow>
                        <VCol cols="12" style="min-height: 150px;">
                            <div class="row d-flex align-center">                                    
                                <VTextarea v-model="rewardText" rows="10" :rules="[requiredValidator]"></VTextarea>
                            </div>                            
                        </VCol>                        
                    </VRow>
                    <VRow class="mb-4">
