...
<template>   
  ...
  <VRow class="d-flex align-center justify-center">
      <VCol cols="6" class="d-flex justify-space-between">
          <VBtn @click="handleUndo" class="mr-2" color="info">
              <VIcon :size="22" icon="tabler-arrow-back-up"/>            
          </VBtn>
          <VBtn @click="handleClearCanvas" class="mr-2" color="info">
              <VIcon :size="22" icon="tabler-trash"/>            
          </VBtn>
          <VBtn @click="handleSaveSignature" class="mr-2" color="info">
              <VIcon :size="22" icon="tabler-device-floppy"/>
          </VBtn>
      </VCol>
  </VRow>
  <VRow>
    <VCol cols="6" class="d-flex mx-auto align-center justify-center">
      <VRow>
        <VCol cols="8">
          <VSlider
        ...
        <VCol cols="4" class="text-center mt-2 px-2">
          <p class="text-center">{{ options.maxWidth }}</p>
        </VCol>
      </VRow>
    </VCol>
  </VRow>
