              ...
              <VCol cols="6">
                ...
                <VTable class="border">
                  <tbody>
                    ...
                    >
                      <td :class="[selectedStaff.id == item.id ? 'bg-primary' : '']">
                        {{ index + 1 }}
                      </td>
                      <td :class="[selectedStaff.id == item.id ? 'bg-primary' : '']">
                ...
                >
                  ...
                  <VRow class="mb-4 px-4 d-flex"> 
                    <VCol class="d-flex align-center">
                      ...
                      <VRadioGroup
                        v-model="selectedStaff['frequency']"
                        inline
                        class="ms-4"
                        required
                  ...
                  <VRow class="mb-4 px-4 d-flex"> 
                    <VCol class="d-flex align-center">
                      ...
                      <VTextField
                        v-model="selectedStaff['withholding']"
                        type="number"
                        variant="underlined"
                        label="Withholding"
                        :rules="[requiredValidator]"
